...
#include "xplane_interfaces/msg/detail/uav_state__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = xplane_interfaces::msg::UAVState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const xplane_interfaces::msg::UAVState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<xplane_interfaces::msg::UAVState *>(
    untyped_ros_message);
...
{
  return &xplane_interfaces::msg::typesupport_fastrtps_cpp::_UAVState__handle;
}
